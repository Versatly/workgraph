...
import { startWorkgraphMcpHttpServer, type WorkgraphMcpHttpServerHandle } from './mcp-http-server.js';
...
export interface WorkgraphServerHandle extends WorkgraphMcpHttpServerHandle {
  workspacePath: string;
...
export async function waitForShutdown(
  handle: Pick<WorkgraphMcpHttpServerHandle, 'close'>,
